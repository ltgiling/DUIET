...
#define PCD_AUTHENT           0x0E               // autenticaciÛn de clave
#define PCD_RECEIVE           0x08               // recepciÛn de datos
...
#define PICC_ANTICOLL         0x93               // anti-colisiÛn
#define PICC_SElECTTAG        0x93               // elecciÛn de tarjeta
#define PICC_AUTHENT1A        0x60               // verificaciÛn key A
#define PICC_AUTHENT1B        0x61               // verificaciÛn Key B
...
//MF522 CÛdigo de error de comunicaciÛn cuando regresÛ
#define MI_OK                 0
